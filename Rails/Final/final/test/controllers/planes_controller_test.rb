...
class PlanesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post planes_url, params: { plane: { manufacturer: @plane.manufacturer, model: @plane.model, seatts: @plane.seatts } }
    end
  ...
  test "should update plane" do
    patch plane_url(@plane), params: { plane: { manufacturer: @plane.manufacturer, model: @plane.model, seatts: @plane.seatts } }
